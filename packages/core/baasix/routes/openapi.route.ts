...
function getSystemEndpoints(): EndpointInfo[] {
    ...
    const schemaEndpoints = env.get("OPENAPI_INCLUDE_SCHEMA") === "true" ? [
        ...
        { path: "/schemas/{collectionName}", method: "PATCH", type: "system", category: "schema", description: "Update schema" },
        { path: "/schemas/{collectionName}", method: "DELETE", type: "system", category: "schema", description: "Delete schema" },
        { path: "/schemas/{collectionName}/fields", method: "POST", type: "system", category: "schema", description: "Add field to schema" },
        { path: "/schemas/{collectionName}/fields/{fieldName}", method: "PATCH", type: "system", category: "schema", description: "Update field in schema" },
        { path: "/schemas/{collectionName}/fields/{fieldName}", method: "DELETE", type: "system", category: "schema", description: "Delete field from schema" },
