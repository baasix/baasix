...
export const systemSchemas = {
    schemas: [
        ...
        {
            collectionName: "baasix_Page",
            schema: {
                name: "Page",
                timestamps: true,
                usertrack: true,
                realtime: { enabled: true, actions: ["insert", "update", "delete"] },
                fields: {
                    id: {
                        type: "UUID",
                        primaryKey: true,
                    ...
                    name: { type: "String", allowNull: false, SystemGenerated: "true" },
                    slug: { type: "String", allowNull: false, SystemGenerated: "true" },
                    icon: {
                        type: "String",
                        allowNull: true,
                        SystemGenerated: "true",
                    ...
                    description: { type: "Text", allowNull: true, SystemGenerated: "true" },
                    parent_Id: { type: "UUID", allowNull: true, SystemGenerated: "true" },
                    parent: {
                        relType: "BelongsTo",
                        target: "baasix_Page",
                ...
                indexes: [
                    {
                        ...
                        unique: true,
                        nullsNotDistinct: true,
                        name: "baasix_Page_tenant_slug_unique",
                        SystemGenerated: "true",
                    },
                ],
            },
        },
        {
            ...
            schema: {
                ...
                fields: {
                    ...
                    page_Id: { type: "UUID", allowNull: false, SystemGenerated: "true" },
                    page: {
                        relType: "BelongsTo",
                        target: "baasix_Page",
                        foreignKey: "page_Id",
                    ...
                    type: {
                        type: "ENUM",
                        values: ["table", "form", "details", "kanban", "calendar", "chart", "cardlist", "map", "markdown", "filter", "buttons", "media", "feed", "iframe", "upload", "code"],
                        allowNull: false,
                        SystemGenerated: "true",
                    },
                    collection: { type: "String", allowNull: true, SystemGenerated: "true" },
                    position: {
                        type: "JSON",
                        allowNull: true,
                        SystemGenerated: "true",
