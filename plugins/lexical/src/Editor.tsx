...
export default function Editor({ placeholder: placeholderProp, maxLength }: EditorProps): JSX.Element {
  ...
  const placeholder = placeholderProp ?? (isRichText
  ...
  return (
    <>
      ...
      <div
        ...
        {(maxLength != null || isMaxLength) && <MaxLengthPlugin maxLength={maxLength ?? 30} />}
        <DragDropPaste />
