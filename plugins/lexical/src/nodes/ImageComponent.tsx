...
import brokenImageImport from '../images/image-broken.svg';
...
const brokenImage = (typeof brokenImageImport === 'string' ? brokenImageImport : (brokenImageImport as {src: string}).src) as string;
...
export default function ImageComponent({
  ...
  const {
    settings: {showTreeView: showNestedEditorTreeView},
  } = useSettings();
