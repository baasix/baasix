...
import {getKatexSync} from '../ui/KatexRenderer';
...
export class EquationNode extends DecoratorNode<JSX.Element> {
  ...
  exportDOM(): DOMExportOutput {
    ...
    // Use katex synchronously if already loaded (it will be, since
    // EquationComponent renders via KatexRenderer which triggers the load).
