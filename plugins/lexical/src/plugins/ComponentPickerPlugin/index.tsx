...
import {InsertNotesDialog} from '../NotesPlugin';
...
export function getBaseOptions(editor: LexicalEditor, showModal: ShowModal) {
  return [
    ...
    new ComponentPickerOption('Terminology', {
      ...
      onSelect: () =>
        showModal('Insert Terminology', (onClose) => (
          <InsertTerminologyDialog activeEditor={editor} onClose={onClose} />
        )),
    }),
    new ComponentPickerOption('Notes', {
      icon: <i className="icon paragraph" />,
      keywords: ['notes', 'formatted', 'tnr'],
      onSelect: () =>
        showModal('Insert Notes', (onClose) => (
          <InsertNotesDialog activeEditor={editor} onClose={onClose} />
        )),
    }),
    new ComponentPickerOption('Revision Points', {
      icon: <i className="icon check-list" />,
      keywords: ['revision', 'review', 'checklist', 'tnr'],
      onSelect: () =>
