                ...
                <DropDownItem
                  onClick={() => {
                    showModal('Insert Terminology', (onClose) => (
                      <InsertTerminologyDialog activeEditor={activeEditor} onClose={onClose} />
                    ));
                  }}
                  className="item">
                  <i className="icon quote" />
                  <span className="text">Terminology</span>
                </DropDownItem>
                <DropDownItem
                  onClick={() => {
                    showModal('Insert Notes', (onClose) => (
                      <InsertNotesDialog activeEditor={activeEditor} onClose={onClose} />
                    ));
                  }}
                  className="item">
                  <i className="icon paragraph" />
                ...
                <DropDownItem
                  onClick={() => {
                    showModal('Insert Revision Points', (onClose) => (
                      <InsertRevisionDialog activeEditor={activeEditor} onClose={onClose} />
                    ));
                  }}
                  className="item">
                  <i className="icon check-list" />
